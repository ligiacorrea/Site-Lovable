    ...
    <section className="min-h-screen flex items-center pt-20 bg-background">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-3xl mx-auto animate-fade-in">
          {/* Headline */}
          <h1 className="font-display text-3xl md:text-4xl lg:text-[2.75rem] leading-tight font-medium text-foreground mb-4 tracking-tight">
          ...
          {/* Intro Paragraph */}
          <div className="space-y-4 text-base md:text-lg text-muted-foreground leading-relaxed mb-12">

      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-muted-foreground max-w-2xl mb-12 leading-relaxed text-sm md:text-base">
            For me, content strategy is not only about writing better interface text. It is about understanding complexity and building systems that make products easier to understand, use and evolve. My work usually follows four main stages:
          </p>
